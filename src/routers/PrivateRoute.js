...
/*
  ...
  to se if an user is loged in or not. Authentication state is found in our store in object authReducer and porperty uid. 
  ...
  By using the react-redux hook "useSelector" we can acces the the state we want to use - state.authReducer.uid
